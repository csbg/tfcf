...
for id in ECCITE8_IRR_d14 ECCITE8_OP1_d7 ECCITE8_OP1_d9 ECCITE8_OP2_d7 ECCITE8_OP2_d9 ECCITE8_OP3_d7 ECCITE8_OP3_d9 ECCITE8_Toxin_d14; do
	...
	echo "/usr/local/AGFORTELNY//PROJECTS/TfCf/NewData/demux_fastq/,3mRNA_$id2,Gene Expression" >> $file
	echo "/usr/local/AGFORTELNY//PROJECTS/TfCf/NewData/demux_fastq/,CRISPR_$id2,CRISPR Guide Capture" >> $file
done
...
for id_original in ECCITE8_IRR_d14 ECCITE8_OP1_d7 ECCITE8_OP1_d9 ECCITE8_OP2_d7 ECCITE8_OP2_d9 ECCITE8_OP3_d7 ECCITE8_OP3_d9 ECCITE8_Toxin_d14; do
